...
import { LayoutDashboard, Wallet, Settings, LogOut, User } from "lucide-react";
  ...
  return (
    <>
      ...
      <MobileNav>
        ...
        >
          <LogOut size={24} strokeWidth={1.5} color="var(--expense)" />
          <span style={{ color: "var(--expense)" }}>Exit</span>
        </MobileNavItem>
      </MobileNav>
    </>
  );
